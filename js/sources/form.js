document.addEventListener('DOMContentLoaded', function manejarFormulario() {
    ...
    function validarFormulario() {
        ...
        if (!politica.checked) {
            politicaerror.textContent = 'Debes aceptar nuestra política de privacidad para enviarnos tu pedido';
            return false;
        } else {
    ...
    radiobuttons.forEach(radio => radio.addEventListener('change', () => (productoerror.textContent = '')));
    ...
    function actualizarPrecio() {
        ...
        // Sumar valores de los checkboxes extras
    ...
    // Eventos relacionados con el precio
    contador.addEventListener('input', actualizarPrecio);
    checkbox_extras.forEach(checkbox => checkbox.addEventListener('change', actualizarPrecio));
